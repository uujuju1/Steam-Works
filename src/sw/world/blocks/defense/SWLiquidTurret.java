...
public class SWLiquidTurret extends SWTurret {
	public ObjectMap<Liquid, BulletType> ammoTypes = new ObjectMap<>();
	public boolean extinguish = true;

	public boolean requireShootingSound = true;

	public SWLiquidTurret(String name) {
		super(name);
		hasLiquids = true;
	...
	public class SWLiquidTurretBuild extends SWTurretBuild {

		@Override
		public boolean shouldActiveSound() {
			return requireShootingSound ? wasShooting && enabled : super.shouldActiveSound();
		}
